...
export default function NewClubTeamPage() {
  ...
  const [form, setForm] = useState({ name: "", gender: "", ageGroup: "", division: "" });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Error", description: err instanceof Error ? err.message : "Failed to create team", variant: "destructive" });
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <AuthGuard requiredRoles={["club_admin"]}>
      <DashboardShell title="New Team" description="Create a new team for your club.">
