...
const adminNav: NavItem[] = [
  ...
  { label: "Squad Approvals", href: "/admin/squads", icon: ClipboardList },
...
const clubNav: NavItem[] = [
  ...
  { label: "Teams", href: "/club/teams", icon: UsersRound },
  { label: "Players", href: "/club/players", icon: Users },
  { label: "Squads", href: "/club/squads", icon: ClipboardList },
  { label: "Matches", href: "/club/matches", icon: Swords },
  { label: "Calendar", href: "/club/calendar", icon: Calendar },
  { label: "Articles", href: "/club/articles", icon: FileText },
  { label: "Users", href: "/club/users", icon: UserCog },
];

const teamNav: NavItem[] = [
  { label: "Dashboard", href: "/team", icon: LayoutDashboard },
  { label: "Teams", href: "/team/teams", icon: UsersRound },
  ...
  return (
    <>
      {items.map((item) => {
        ...
        const isActive =
          pathname === item.href ||
          (item.href !== "/admin" && item.href !== "/official" && item.href !== "/club" && item.href !== "/team" && item.href !== "/player" && item.href !== "/root" && pathname.startsWith(item.href));
        return (
          <Link
            key={item.href}
            href={item.href}
