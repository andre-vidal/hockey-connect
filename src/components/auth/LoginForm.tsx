  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription>Sign in to your Hockey Connect account</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <Button variant="ghost" className="w-full text-gray-500" onClick={handleAnonymousLogin} disabled={loading}>
          Continue as guest
        </Button>
      </CardContent>
